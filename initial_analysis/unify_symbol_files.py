...
# Takes 2 symbol recommendations and creates a file containing symbols from both,
# while removing duplicates.

name1 = "unfiltered_symbols.txt"
name2 = "more_symbols.txt"

if os.path.exists("No longer needed files/symbols_unified.txt"):
...
symbols_file = open("No longer needed files/symbols_unified.txt", "a")
